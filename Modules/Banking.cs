...
public class Account
{
    ...
    public Account(string accountNumber, AccountType type, SnoutUser accountHolder, decimal balance, string currency, decimal overdraftLimit, decimal interestRate, decimal accountFees, List<Transaction> transactionHistory)
    {
